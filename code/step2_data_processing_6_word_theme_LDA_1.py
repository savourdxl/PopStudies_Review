...
# example
# how to compute coherence score
...
coherence_model_lda = CoherenceModel(model=lda_model, texts=keywords_list_r,
                                     dictionary=keywords_dict,coherence='c_v')
coherence_lda = coherence_model_lda.get_coherence()
print('Coherence Score:', coherence_lda)
# Coherence Score: 0.6717681297487836
...
plt.savefig(path+'\\picture\\coherence_score_1.png')

# 0.7026169588993904
# number of topics : 26
# coherence_values.index(max(coherence_values)) 24
...
pyLDAvis.save_html(my_pic, path+'\\picture\\lda_1.html')
